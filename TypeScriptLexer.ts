...
export default class TypeScriptLexer extends TypeScriptLexerBase {
	...
	public static readonly symbolicNames: (string | null)[] = [ null, "MultiLineComment", 
                                                             ...
                                                             "TemplateStringAtom" ];
	public static readonly modeNames: string[] = [ "DEFAULT_MODE", "TEMPLATE", ];
	...
	public get literalNames(): (string | null)[] { return TypeScriptLexer.literalNames; }
	public get symbolicNames(): (string | null)[] { return TypeScriptLexer.symbolicNames; }
	public get ruleNames(): string[] { return TypeScriptLexer.ruleNames; }

	public get serializedATN(): number[] { return TypeScriptLexer._serializedATN; }
	...
	private OpenBrace_action(localctx: RuleContext, actionIndex: number): void {
		switch (actionIndex) {
		case 0:
	...
	private CloseBrace_action(localctx: RuleContext, actionIndex: number): void {
		switch (actionIndex) {
		case 1:
	...
	private StringLiteral_action(localctx: RuleContext, actionIndex: number): void {
		switch (actionIndex) {
		case 2:
	...
	private BackTick_action(localctx: RuleContext, actionIndex: number): void {
		switch (actionIndex) {
		case 3:
	...
	private BackTickInside_action(localctx: RuleContext, actionIndex: number): void {
		switch (actionIndex) {
		case 4:
	...
	private TemplateStringStartExpression_action(localctx: RuleContext, actionIndex: number): void {
		switch (actionIndex) {
		case 5:
	...
	private RegularExpressionLiteral_sempred(localctx: RuleContext, predIndex: number): boolean {
		switch (predIndex) {
		case 0:
	...
	private TemplateCloseBrace_sempred(localctx: RuleContext, predIndex: number): boolean {
		switch (predIndex) {
		case 1:
	...
	private OctalIntegerLiteral_sempred(localctx: RuleContext, predIndex: number): boolean {
		switch (predIndex) {
		case 2:
	...
	public static readonly _serializedATN: number[] = [4,0,148,1327,6,-1,6,
	...
	static DecisionsToDFA = TypeScriptLexer._ATN.decisionToState.map( (ds: DecisionState, index: number) => new DFA(ds, index) );
}