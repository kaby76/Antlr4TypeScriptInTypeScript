...
$(& antlr4 -v $version TypeScriptLexer.g4 -encoding utf-8 -Dlanguage=TypeScript   ; $compile_exit_code = $LASTEXITCODE) | Write-Host
if($compile_exit_code -ne 0){
    exit $compile_exit_code
}
$(& antlr4 -v $version TypeScriptParser.g4 -encoding utf-8 -Dlanguage=TypeScript   ; $compile_exit_code = $LASTEXITCODE) | Write-Host
if($compile_exit_code -ne 0){
    exit $compile_exit_code
}
